...
- **Blocked objective buckets**: `/qa/objective-runtime-coverage` currently keeps `cveDatabaseEmbeddings` and `l2DiskCacheStorageHit` visible as blocked requirements when their underlying live/evidence contracts do not prove full readiness.
