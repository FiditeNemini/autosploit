...
EXPECTED_NON_PASSING_LIVE_PROOFS = {
    ...
    "docs/live-proofs/2026-07-06-real-qwen-natural-tool-choice-27b.json": "partial independent natural-language Qwen 27B tool-choice attempt without stable final continuation/report proof",
}
