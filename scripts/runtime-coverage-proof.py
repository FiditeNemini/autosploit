...
EXPECTED_LIVE_ARTIFACTS = {
    ...
    "releaseAppQwen27BCrossRestartCache": ("docs/live-proofs/2026-07-05-release-app-qwen-cross-restart-cache-27b-current.json", "qwen-release-app"),
    "releaseAppQwen35BCrossRestartCache": ("docs/live-proofs/2026-07-05-release-app-qwen-cross-restart-cache-35b-current.json", "qwen-release-app"),
