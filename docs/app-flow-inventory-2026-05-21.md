...
- Static scans proving no S/M/L profile selectors or `ModelProfile` code remain
  ...
  `qwenMultimodalRuntime` contract with blocked model kinds plus count fields
  ...
  contract, route list/count, route-owned contract flags/count, and action telemetry field
  list/count,
